...
/**
 * A unidirectional link between two {@link Agent}s. One Agent is the {@link #sourceAgent()} and provides something to the
 * {@link #destAgent()}. Typically, the product is complete as the source is concerned; the source will have nothing else
